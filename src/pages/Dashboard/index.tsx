...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const { transactions: Transactions, balance: Balance } = response.data;

      const formatedTransactions: Transaction[] = Transactions.map(
...
// formatDate(parseISO(transaction.created_at))
